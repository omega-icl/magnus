...
pyEXPDESOptions
 ...
 .def_readwrite( "MAXITER",   &EXPDES::Options::MAXITER,   "maximal number of iterations [Default: 4]" )
 .def_readwrite( "TOLITER",   &EXPDES::Options::TOLITER,   "stopping tolerance for iterations [Default: 1e-4]" )
 .def_readwrite( "MAXTHREAD", &EXPDES::Options::MAXTHREAD, "maximal number of parallel threads [Default: 1]" )
