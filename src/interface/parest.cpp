...
mc_parest(py::module_& m)
{
  ...
  pyPAREST.def(py::init<>())
      .def_readwrite("options", &PAREST::options)
      .def(
          "set_dag", [](PAREST& self, FFGraph& dag) { self.set_dag(dag); },
          py::keep_alive<1, 2>(), "set DAG")
      .def_property_readonly(
          "dag", [](PAREST const& self) { return &self.dag(); },
          py::return_value_policy::reference_internal, "DAG")
      .def_property_readonly(
          "np", [](PAREST const& self) { return self.np(); },
          "number of estimated parameters")
      .def(
          "set_parameter",
          [](PAREST& self, std::vector<mc::FFVar> const& p,
             std::vector<double> const& plb, std::vector<double> const& pub)
          { self.set_parameter(p, plb, pub); },
          py::arg("var"), py::arg("lb") = std::vector<double>(),
          py::arg("ub") = std::vector<double>(), "set estimated parameters")
      .def_property_readonly(
          "var_parameter",
          [](PAREST const& self) { return self.var_parameter(); },
          py::return_value_policy::reference_internal, "estimated parameters")
      .def_property_readonly(
          "nc", [](PAREST const& self) { return self.nc(); },
          "number of model constants")
      .def(
          "set_constant",
          [](PAREST& self, std::vector<mc::FFVar> const& c,
             std::vector<double> const& cval) { self.set_constant(c, cval); },
          py::arg("var"), py::arg("val") = std::vector<double>(),
          "set model constants")
      .def(
          "reset_constant", [](PAREST& self) { self.reset_constant(); },
          "reset model constants")
      .def_property_readonly(
          "var_constant",
          [](PAREST const& self) { return self.var_constant(); },
          py::return_value_policy::reference_internal, "model constants")
      .def(
          "nu",
          [](PAREST const& self, size_t const mod) { return self.nu(mod); },
          py::arg("mod") = 0, "number of model controls")
      .def(
          "ny",
          [](PAREST const& self, size_t const mod) { return self.ny(mod); },
          py::arg("mod") = 0, "number of model outputs")
      .def(
          "add_model",
          [](PAREST& self, std::vector<mc::FFVar> const& y,
             std::vector<mc::FFVar> const& u, size_t const mod)
          { self.add_model(y, u, mod); },
          py::arg("out"), py::arg("in") = std::vector<mc::FFVar>(),
          py::arg("mod") = 0, "add model")
      .def(
          "reset_model", [](PAREST& self) { self.reset_model(); },
          "reset model")
      .def(
          "var_control", [](PAREST const& self, size_t const mod)
          { return self.var_control(mod); },
          py::return_value_policy::reference_internal, py::arg("mod") = 0,
          "model controls")
      .def(
          "var_output", [](PAREST const& self, size_t const mod)
          { return self.var_output(mod); },
          py::return_value_policy::reference_internal, py::arg("mod") = 0,
          "model outputs")
      .def_property_readonly(
          "nd", [](PAREST const& self) { return self.nd(); },
          "number of experiments")
      .def(
          "set_data", [](PAREST& self, std::vector<PAREST::Experiment> const& d)
          { self.set_data(d); }, "set experimental data")
      .def(
          "add_data", [](PAREST& self, std::vector<PAREST::Experiment> const& d)
          { self.add_data(d); }, "add experimental data")
      .def(
          "add_data", [](PAREST& self, PAREST::Experiment const& d)
          { self.add_data(d); }, "add experimental data")
      .def_property_readonly(
          "data", [](PAREST const& self) { return &self.get_data(); },
          py::return_value_policy::reference_internal, "experimental data")
      .def(
          "add_regularization",
      ...
      .def_property_readonly(
          ...
          py::return_value_policy::reference_internal, "model constraints")
      .def(
          "reset_constraint", [](PAREST& self) { self.reset_constraint(); },
          "reset model constraints")
      .def(
          "add_constraint",
          [](PAREST& self, mc::FFVar const& lhs, NLPSLV::t_CTR const& type,
             mc::FFVar const& rhs) { self.add_constraint(lhs, type, rhs); },
          py::arg("lhs"), py::arg("type"), py::arg("rhs") = mc::FFVar(0.),
          "add constraint")
      .def(
          "setup", [](PAREST& self) { self.setup(); },
      ...
      .def(
          ...
          py::arg("conf") = 0.95, py::arg("cst") = std::vector<double>(),
      ...
      .def(
          "mle_solve",
          [](PAREST& self, std::vector<double> const& par,
             std::vector<double> const& cst)
          {
            py::scoped_ostream_redirect stream(
                std::cout,                                 // std::ostream&
                py::module_::import("sys").attr("stdout")  // Python output
          ...
          py::arg("par"), py::arg("cst") = std::vector<double>(),
      ...
      .def(
          ...
          py::arg("nsam"), py::arg("cst") = std::vector<double>(),
          "solve maximum-likelihood parameter estimation problem")
      .def(
          "chi2_test",
          ...
          py::arg("conf") = 0.95, "compute chi-squared test (goodness-of-fit)")
      .def(
          "bootstrap_sample",
          [](PAREST& self,
             std::vector<std::vector<PAREST::Experiment>> const& data,
             size_t const nsam)
          {
            py::scoped_ostream_redirect stream(
                std::cout,                                 // std::ostream&
      ...
      .def(
          "bootstrap_sample",
          [](PAREST& self, std::vector<PAREST::Experiment> const& data,
             size_t const nsam)
          {
            py::scoped_ostream_redirect stream(
                std::cout,                                 // std::ostream&
                 ...
                 parsam)
          {
            ...
            if (info.format != py::format_descriptor<double>::format())
              throw std::runtime_error(
                  "Incompatible format: double array expected");
            if (info.ndim != 2)
              throw std::runtime_error(
                  "Incompatible buffer dimension: 2d array expected");
            // Convert arma::mat to numpy array using auxiliary memory
            arma::mat covmat = self.cov_sample(
                arma::mat(static_cast<double*>(info.ptr), info.shape[0],
                          info.shape[1], false, true));
      ...
      .def(
          ...
          py::return_value_policy::reference_internal,
          "compute parameter covariance matrix from sampled parameter "
          "posterior")
      .def(
          "cov_linearized",
          [](PAREST& self)
      ...
      .def(
          ...
          py::arg("cov"), py::arg("conf") = 0.95, py::arg("type") = "T",
          py::return_value_policy::reference_internal,
      ...
      .def(
          ...
          [](PAREST& self,
             py::array_t<double, py::array::c_style | py::array::forcecast>
                 covmat,
             size_t const i, size_t const j, double const& conflevel,
             std::string const& type, size_t const nsam)
          {
            py::scoped_ostream_redirect stream(
                std::cout,                                 // std::ostream&
                py::module_::import("sys").attr("stdout")  // Python output
          ...
          py::arg("cov"), py::arg("first"), py::arg("second"),
          py::arg("conf") = 0.95, py::arg("type") = "F", py::arg("nsam") = 50,
          py::return_value_policy::reference_internal,
          "compute parameter confidence intervals")
      .def(
          "hpd_region",
          [](PAREST const& self, const double& level)
          {
            ...
            return std::make_pair(
                py::array_t<double>(mshape, mstrides, par.memptr()),
      ...
      .def(
          ...
          [](PAREST const& self, const double& level)
          {
            ...
            size_t strides[ndim]{elsize};
            return std::make_pair(
                py::array_t<double>(shape, strides, lvec.memptr()),
      ...
      .def_property_readonly(
          "par_best", [](PAREST const& self) { return self.par_best(); },
          py::return_value_policy::reference_internal,
  ...
  py::class_<arma::mat>(m, "Mat", py::buffer_protocol())
      ...
      .def(py::init(
          [](py::buffer b)
          {
            ...
            return arma::mat(static_cast<double*>(info.ptr), info.shape[0],
                             info.shape[1], false, true);
          }));
  ...
  pyPARESTRec.def(py::init<>())
      .def(py::init<std::vector<double> const&, double const&>(),
           py::arg("meas"), py::arg("var") = 0.)
      .def(py::init<PAREST::Record const&>())
      .def_property(
          "measurement", [](PAREST::Record& self) { return self.measurement; },
          [](PAREST::Record& self, std::vector<double> const& measurement)
          { self.measurement = measurement; }, "measurement replicates")
      .def_property(
          "variance", [](PAREST::Record& self) { return self.variance; },
          [](PAREST::Record& self, double const& variance)
          { self.variance = variance; }, "measurement variance");
  ...
  pyPARESTExp
      ...
      .def(py::init<std::vector<double> const&,
                    std::map<size_t, PAREST::Record> const&, size_t const>(),
           py::arg("in"), py::arg("out") = std::map<size_t, PAREST::Record>(),
           py::arg("mod") = 0)
      .def(py::init<PAREST::Experiment const&>())
      .def_property(
          "index", [](PAREST::Experiment& self) { return self.index; },
          [](PAREST::Experiment& self, size_t const index)
          { self.index = index; }, "model index")
      .def_property(
          "control", [](PAREST::Experiment& self) { return self.control; },
          [](PAREST::Experiment& self, std::vector<double> const& control)
          { self.control = control; }, "control values")
      .def_property(
          "output", [](PAREST::Experiment& self) { return self.output; },
          [](PAREST::Experiment& self,
             std::map<size_t, PAREST::Record> const& output)
          { self.output = output; },
          "measurement records");

  py::class_<PAREST::Options> pyPARESTOptions(pyPAREST, "Options");

  pyPARESTOptions.def(py::init<>())
      .def(py::init<PAREST::Options const&>())
      .def_readwrite("DISPLEVEL", &PAREST::Options::DISPLEVEL,
                     "Verbosity level [Default: 1]")
      .def_readwrite("RNGSEED", &PAREST::Options::RNGSEED,
                     "Random-number generator seed (=0: Sobol sampling; >0: "
                     "seed set to specified value; <0: seed set to a value "
                     "drawn from std::random_device) [Default: -1]")
      .def_readwrite("NLPSLV", &PAREST::Options::NLPSLV,
                     "Options of gradient-based solver")
      .def_readwrite("NSSLV", &PAREST::Options::NSSLV,
                     "Options of nested sampling solver");
}
