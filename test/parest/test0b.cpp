...
// based on Lobry et al (1991, Binary 3:86,
// http://pbil.univ-lyon1.fr/members/lobry/articles/Binary_1991_3_86.pdf)
////////////////////////////////////////////////////////////////////////
int
main()
////////////////////////////////////////////////////////////////////////
{
  ...
  std::vector<mc::PAREST::Experiment> Data{
      {{294}, {{0, {{0.25}, 0.01}}}}, {{296}, {{0, {{0.56}, 0.01}}}},
      {{298}, {{0, {{0.61}, 0.01}}}}, {{300}, {{0, {{0.79}, 0.01}}}},
      {{302}, {{0, {{0.94}, 0.01}}}}, {{304}, {{0, {{1.04}, 0.01}}}},
      {{306}, {{0, {{1.16}, 0.01}}}}, {{308}, {{0, {{1.23}, 0.01}}}},
      {{310}, {{0, {{1.36}, 0.01}}}}, {{312}, {{0, {{1.32}, 0.01}}}},
      {{314}, {{0, {{1.36}, 0.01}}}}, {{316}, {{0, {{1.34}, 0.01}}}},
      {{318}, {{0, {{0.96}, 0.01}}}}, {{319}, {{0, {{0.83}, 0.01}}}},
      {{320}, {{0, {{0.16}, 0.01}}}},
  };
