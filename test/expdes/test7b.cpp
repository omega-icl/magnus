...
////////////////////////////////////////////////////////////////////////
{
  ...
  std::vector<double> dU{9.03125e-01, 8.25156e-01, 5.98344e-02,
                         1.10938e+00, 5.46875e-01, 3.13438e+01};
  //  std::vector<double>
  //  dU{ 8.18750e-01, 8.32812e-01, 4.86313e-02, 9.68750e-01, 1.53125e+00, 2.44375e+01
  //  }; std::vector<double>
  //  dU{ 9.94087e-01, 8.32946e-01, 5.43341e-02, 1.20523e+00, 1.19121e+00, 2.85314e+01
  //  }; std::vector<double>
  //  dU{ 9.96875e-01, 8.22969e-01, 1.05406e-02, 1.01562e+00, 1.01562e+00, 2.40312e+01
  //  };

  // #2 	0.800 	0.800 	0.036 	1.743 	1.826 	22.0 	0.0018
  // 0.020 	67.9
  //  std::vector<double> dU{ 0.8, 0.8, 0.036, 1.743, 1.826, 22.0 };
  // #1 	0.800 	0.800 	0.025 	0.729 	2.000 	22.0 	0.0020
  // 0.020 	67.9
  ...
  for (unsigned int j = 0; j < NY; j++)
    Y[j] =
        OpODE(j, NU, U.data(), NP, P.data(), &IVP);  //, mc::FFODE::SHALLOW );
  // std::cout << DAG;
  ...
  DOE.options.MINLPSLV.NLPSLV.GRADMETH =
      DOE.options.MINLPSLV.NLPSLV.FAD;  // SYM;
  ...
  try
  {
    ...
    //    DOE.file_export(
    //    "test7b_N="+std::to_string(NEXP)+"_"+std::to_string(NUSAM) );
    DOE.stats.display();
