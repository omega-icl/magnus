...
////////////////////////////////////////////////////////////////////////
{
  ...
  std::vector<std::vector<mc::FFVar>> FCT(
      NS + 1, std::vector<mc::FFVar>(NY * NS, 0.));  // State functions
  ...
  for (unsigned int j = 0; j < NY * NS; j++)
    Y[j] = OpODE(j, NC, C.data(), NP, P.data(), &IVP);

  std::vector<double> dP, dC;
  dP.assign({1.09e-1 * 36e2, 9.33e0, 3.39e-3 * 36e2, 1.09e-6 * 36e2,
             1.17e-5 * 36e2, 1.93e-6 * 36e2, 1.87e-8 * 36e2});
