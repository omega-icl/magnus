...
////////////////////////////////////////////////////////////////////////
{
  ...
  for (unsigned int j = 0; j < NY * NS; j++)
    Y[j] =
        OpODE(j, NC, C.data(), NK, K.data(), &IVP);  //, mc::FFODE::SHALLOW );
  // std::cout << DAG;
  /*
    /////////////////////////////////////////////////////////////////////////
    // Simulate model
    ...
    DAG.eval( NY*NS, Y.data(), dY.data(), NC, C.data(), dC.data(), NK, K.data(),
    dK.data() ); for( unsigned i=0, k=0; i<NS; i++ ) for( unsigned j=0; j<NY;
    j++, k++ ) std::cout << "Y[" << i << "][" << j << "] = " << dY[k] <<
    std::endl;
  */
  /////////////////////////////////////////////////////////////////////////
  // Perform MBDOE
