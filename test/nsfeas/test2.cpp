...
// Example 2 in Paulen et al (2020,
// https://doi.org/10.1016/j.ifacol.2020.12.555)
////////////////////////////////////////////////////////////////////////
int
main()
////////////////////////////////////////////////////////////////////////
{
  ...
  {
    dU[k] = 1e-1 * k;
    DAG.eval(NY, &Y[0], &dY[k], NU, &U[0], &dU[k], NP, &P[0],
             &nomP[0]);  // nominal noisefree measurements at P=[1 1]
    // std::cout << k << ": " << dY[k];
  ...
  for (unsigned int k = 0; k < NT; k++) G[k] = -P[0] * exp(P[1] * dU[k]);
